...
class Footer extends Component {
    render() {
      ...
      <div className="infodreamhomecom">info@dreamhome.com</div>
      <div className="div12">(+84) 369 912 793</div>
      ...
      <div className="icons8-address-64-1-parent">
        <div className="icons8-address-64-1" />
        <div className="group-child40" />
        <img
          className="icons8-address-64-2-1"
          alt=""
          src="/icons8address64-2-1@2x.png"
        />
      </div>
      <div className="icons8-address-64-1-group">
        <div className="icons8-address-64-1" />
        <div className="group-child40" />
      </div>
      <div className="icons8-address-64-1-container">
        <div className="icons8-address-64-1" />
        <div className="group-child40" />
      </div>
      <img className="icons8-email-50-1" alt="" src="/icons8email50-1@2x.png" />
      <img className="icons8-phone-50-1" alt="" src="/icons8phone50-1@2x.png" />
    </div> 
